                ...
                <div class="Post-Body">
                    ...
                    <div class="Post-Metrics">
                        <div class="Post-Action-Bar">
                            <button class="Post-Action-Btn Like ${post.liked ? 'liked' : ''}" aria-label="좋아요">
            ...
            <div class="postBody">
                ...
                <footer class="postMetrics">
                    <div class="tweet-action-bar">
                        ...
                        <button type="button" class="tweet-action-btn tweet-action-btn--like ${post.liked ? 'liked' : ''}" data-testid="like" aria-label="마음 ${post.likeCount ?? 0}">
                            <svg viewBox="0 0 24 24" aria-hidden="true" class="tweet-action-icon">
                                <g><path
                                    d="${post.liked 
