window.onload = () => {
    ...
    /** Google Charts에서 공통으로 사용하는 기본 옵션 */
    ...
    function drawBarChart() {
        ...
        const data = new google.visualization.DataTable();
        data.addColumn("string", "기간");
        data.addColumn("number", "팔로우");
        data.addColumn("number", "언팔로우");
        data.addRows(rawRows);
