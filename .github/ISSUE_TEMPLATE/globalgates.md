...
body:
  ...
  - type: textarea
    ...
    attributes:
      ...
      placeholder: ex) 회원 프로필 조회 API 응답 필드 추가
    validations:
      required: true
  ...
  - type: textarea
    ...
    attributes:
      label: 🎯 목적
      description: 왜 필요한 작업인가요?
      placeholder: ex) 프론트 요구사항 반영
    validations:
      required: true
